        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'mobile application | Flutter Enthusiast',
              ...
              PortfolioSection(
                ...
                child: Column(
                  children: [
                    ContactInfo(icon: Icons.email, info: 'ab5542219.gmail.com'),
                    ContactInfo(icon: Icons.phone, info: '+03095542218'),
                    ContactInfo(icon: Icons.location_on, info: 'lahore,punjab'),
                  ],
                ),
              ),
            ],
